        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Website Design</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Search Engine Optimization</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Content Marketing</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Social Media Management</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Google Ads & PPC</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Brand Development</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <Phone className="h-5 w-5 mr-3 text-brand-red shrink-0 mt-0.5" />
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">123 Healthcare Way, London, UK</span>
              </li>
            </ul>
          </div>
        </div>
